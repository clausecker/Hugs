--
-- Haskell wrapper for System.Xml.XmlReader
-- 
module System.Xml.XmlReader where
...
data XmlReader_ a 
type XmlReader a = System.Object.Object (XmlReader_ a)
...
nameTable :: XmlReader a -> IO (System.Xml.XmlNameTable.XmlNameTable b)
nameTable = invoke "get_NameTable" ()

nodeType :: XmlReader a -> IO System.Xml.XmlNodeType
nodeType this = do
...
readState :: XmlReader a -> IO System.Xml.ReadState
readState this = do
...
xmlSpace :: XmlReader a -> IO System.Xml.XmlSpace
xmlSpace this = do
...
moveToContent :: XmlReader a -> IO System.Xml.XmlNodeType
