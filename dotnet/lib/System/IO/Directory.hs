module System.IO.Directory where
...
data Directory_ a
type Directory a = System.Object.Object (Directory_ a)

getParent :: String -> Directory obj -> IO (System.IO.DirectoryInfo.DirectoryInfo a1)
getParent arg0  = invoke "GetParent" arg0
createDirectory :: String -> Directory obj -> IO (System.IO.DirectoryInfo.DirectoryInfo a1)
createDirectory arg0  = invoke "CreateDirectory" arg0
exists :: String -> Directory obj -> IO (Bool)
exists arg0  = invoke "Exists" arg0
setCreationTime :: String -> System.DateTime.DateTime a1 -> Directory obj -> IO (())
setCreationTime arg0 arg1  = invoke "SetCreationTime" (arg0,arg1)
getCreationTime :: String -> Directory obj -> IO (System.DateTime.DateTime a1)
getCreationTime arg0  = invoke "GetCreationTime" arg0
setLastWriteTime :: String -> System.DateTime.DateTime a1 -> Directory obj -> IO (())
setLastWriteTime arg0 arg1  = invoke "SetLastWriteTime" (arg0,arg1)
getLastWriteTime :: String -> Directory obj -> IO (System.DateTime.DateTime a1)
getLastWriteTime arg0  = invoke "GetLastWriteTime" arg0
setLastAccessTime :: String -> System.DateTime.DateTime a1 -> Directory obj -> IO (())
setLastAccessTime arg0 arg1  = invoke "SetLastAccessTime" (arg0,arg1)
getLastAccessTime :: String -> Directory obj -> IO (System.DateTime.DateTime a1)
getLastAccessTime arg0  = invoke "GetLastAccessTime" arg0
getFiles :: String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a1))
getFiles arg0  = invoke "GetFiles" arg0
getFiles_1 :: String -> String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a2))
getFiles_1 arg0 arg1  = invoke "GetFiles" (arg0,arg1)
getDirectories :: String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a1))
getDirectories arg0  = invoke "GetDirectories" arg0
getDirectories_1 :: String -> String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a2))
getDirectories_1 arg0 arg1  = invoke "GetDirectories" (arg0,arg1)
getFileSystemEntries :: String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a1))
getFileSystemEntries arg0  = invoke "GetFileSystemEntries" arg0
getFileSystemEntries_1 :: String -> String -> Directory obj -> IO (System.Array.Array (System.String.StringTy a2))
getFileSystemEntries_1 arg0 arg1  = invoke "GetFileSystemEntries" (arg0,arg1)
getLogicalDrives :: Directory obj -> IO (System.Array.Array (System.String.StringTy a0))
