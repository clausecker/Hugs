...
static int            getInt()       { eval(pop()); return whnfInt; }
static unsigned int   getWord()      { eval(pop()); return (unsigned int) whnfInt; }
static void*          getAddr()      { eval(pop()); return ptrOf(whnfHead); }
static float          getFloat()     { eval(pop()); return whnfFloat; }
static double         getDouble()    { eval(pop()); return (double) whnfFloat; }
static char           getChar()      { eval(pop()); return charOf(whnfHead); }
